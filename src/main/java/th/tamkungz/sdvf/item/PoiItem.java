...
public class PoiItem extends Item {
	public PoiItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A traditional food with a delicate"));
		list.add(Component.literal("sweet flavor when eaten fresh."));
	}

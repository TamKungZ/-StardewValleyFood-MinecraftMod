...
public class TropicalCurryItem extends Item {
	public TropicalCurryItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("An exotic"));
		list.add(Component.literal("fragrant curry served in a pineapple bowl."));
	}

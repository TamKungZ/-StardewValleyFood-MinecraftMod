...
public class MangoStickyRiceItem extends Item {
	public MangoStickyRiceItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Sweet mango and coconut transforms this rice into something very special."));
	}

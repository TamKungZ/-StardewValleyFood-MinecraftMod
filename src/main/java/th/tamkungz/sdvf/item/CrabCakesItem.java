...
public class CrabCakesItem extends Item {
	public CrabCakesItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Crab"));
		list.add(Component.literal("bread crumbs"));
		list.add(Component.literal("and egg formed into patties then fried to a golden brown."));
	}

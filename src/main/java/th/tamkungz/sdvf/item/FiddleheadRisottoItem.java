...
public class FiddleheadRisottoItem extends Item {
	public FiddleheadRisottoItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A creamy rice dish served with sauteed fern heads. It's a little bland."));
	}

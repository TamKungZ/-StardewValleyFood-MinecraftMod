...
public class RicePuddingItem extends Item {
	public RicePuddingItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("It's creamy"));
		list.add(Component.literal("sweet"));
		list.add(Component.literal("and fun to eat."));
	}

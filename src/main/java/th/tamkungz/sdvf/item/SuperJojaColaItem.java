...
public class SuperJojaColaItem extends Item {
	public SuperJojaColaItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.RARE).food((new FoodProperties.Builder()).nutrition(1).saturationMod(0.1f).build()));
	}
